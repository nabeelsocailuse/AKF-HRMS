...
# bench --site erp.alkhidmat.org execute akf_hrms.utils.hr_policy_v01.clean_records
# def clean_records():
# 	count = 0
# 	for d in frappe.db.sql("""
# 				Select name, travel_request from `tabAttendance Request`
# 				Where ifnull(travel_request, "")!=""
# 					""", as_dict=1):
# 		posting_date = frappe.db.get_value("Travel Request", d.travel_request, "posting_date")
# 		frappe.db.set_value("Attendance Request", d.name, "posting_date_travel_request", posting_date)
