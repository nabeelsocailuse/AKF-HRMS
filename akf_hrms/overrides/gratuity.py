...
def calculate_work_experience_alkhidmat(employee, gratuity_rule):
	...
	delta = relativedelta(relieving_date, final_confirmation_date)
	years = delta.years
	months = delta.months
	days = delta.days
	frappe.msgprint(f"years: {years}, months: {months}")
