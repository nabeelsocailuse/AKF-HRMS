...
class XLeaveApplication(Document, PWANotificationsMixin):
	def get_feed(self):
	...
	def validate(self):
		...
		self.validate_time_allowed()
		self.validate_leave_count()
	...
	# MAARIJ SIDDIQUI
	def validate_time_allowed(self):
