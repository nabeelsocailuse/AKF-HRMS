...
class LeaveEncashment(Document):
	...
	def set_encashment_amount(self): #Overriden by Mubarrim
		...
		per_day_encashment = frappe.db.get_value(
			"Salary Structure Assignment", {"employee":self.employee,"docstatus":1}, "custom_per_day"
		)
		# frappe.throw(f"per day: {per_day_encashment}")
