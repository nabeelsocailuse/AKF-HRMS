...
frappe.ui.form.on('Attendance Log', {
    ...
    employee: function(frm) {
        if (frm.doc.employee) {
            frappe.call({
                method: "akf_hrms.akf_hrms.doctype.attendance_log.attendance_log.get_employee_shift",
...
function updateAndProcessAttendance(frm, button_type) {
    frappe.call({
        method: "akf_hrms.akf_hrms.doctype.attendance_log.attendance_log.get_current_datetime",
        callback: function(response) {
...
function check_attendance_status(frm) {
    if (frm.doc.employee && frm.doc.shift) {
        frappe.call({
            method: "akf_hrms.akf_hrms.doctype.attendance_log.attendance_log.check_attendance_status",
...
function CallOpenStreetMap(frm, button_type) {
    navigator.geolocation.getCurrentPosition(
        (position) => {
            frappe.call({
                method: "akf_hrms.akf_hrms.doctype.attendance_log.attendance_log.record_attendance",
                args: {
