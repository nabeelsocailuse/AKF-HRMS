// this doctype is overriden by Mubashir Bashir
...
frappe.ui.form.on("Job Applicant", {
    ...
    custom_date_of_birth: function(frm) {		// Mubashir Bashir
        frm.events.calculate_age(frm);
    },

    calculate_age: function(frm) {  	// Mubashir Bashir
        if (frm.doc.custom_date_of_birth) {
            let birth_date = new Date(frm.doc.custom_date_of_birth);
            let today = new Date();
