...
frappe.ui.form.on("Work From Home Request", {
  setup: function (frm) {
    frm.set_query("leave_approver", function () {
      return {
        query:
          "hrms.setup.doctype.department_approver.department_approver.get_approvers",
        filters: {
  ...
  refresh: function (frm) {
    ...
    //     frappe.call({
    //       method:
    //         "akf_hrms.akf_hrms.doctype.work_from_home_request.work_from_home_request.chk_dublication",
    //       args: { doc_name: frm.doc.name, employee: frm.doc.employee },
    //       callback: function (r) {
    //         if (r.message == "") {
    //           frappe.set_route(
    //             "/app/attendance-request/new-attendance-request-",
    //             {
    //               employee: frm.doc.employee,
    //               work_from_home_request: frm.doc.name,
