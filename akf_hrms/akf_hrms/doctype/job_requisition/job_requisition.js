frappe.ui.form.on("Job Requisition", {
	...
	refresh: function(frm) {
		...
		if (frm.doc.status === "Open & Approved" && frm.doc.docstatus == 0 || frm.doc.docstatus == 1) {
    ...
    frappe.call({
        ...
        callback: function(r) {
            if (r.message) {
                ...
                frm.set_value('custom_workstation_availability', r.message.workstation_availability);
                frm.set_value('custom_laptop_required', r.message.laptop_required);
                frm.set_value('custom_position_type', r.message.position_type);
                frm.set_value('custom_qualification', r.message.qualification);
